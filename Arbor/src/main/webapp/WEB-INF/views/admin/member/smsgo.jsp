<%@ page language="java" import="java.util.*, java.security.*, java.io.*, java.net.*, java.util.Base64.Encoder, java.util.Base64.Decoder" %>
    ...
    if(action.equals("go")) {
        ...
        String user_id = base64Encode("useryh"); // SMS아이디
        String secure = base64Encode("f3ae4a97278fb1e78bb83607f476e789");//인증키
        ...
        String returnurl = nullcheck(request.getParameter("returnurl"), "");//리턴url
