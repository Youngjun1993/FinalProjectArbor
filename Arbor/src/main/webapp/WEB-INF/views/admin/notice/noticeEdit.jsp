...
<div class="w1400_container font_ng clearfix">
	...
	<div class="d_noticeEdit">
		<h1 class="d_h1">공지사항 수정</h1>
		<form method="post" id="noticeEditFrm" action="noticeEditOk" enctype="multipart/form-data">
			<input type="hidden" name="noticeno" value="${noticeEdit.noticeno }"/>
			<div>
				<span class="d_editFont">제목: </span><input type="text" name="noticesubject" id="d_noticeSubject" value="${noticeEdit.noticesubject }"/><br/>
				<br/><br/>
				<textarea name="noticecontent" id="d_noticeInsert">${noticeEdit.noticecontent }</textarea><br/>
				<p class="d_noticeInsertBtn">
					<input type="button" class="adminSubBtn" id="d_insertCnlBtn" value="취소">
					<input type="button" class="adminMainBtn" id="d_noticeEditBtn" value="완료">
				</p>
			</div>
		</form>
	</div>
